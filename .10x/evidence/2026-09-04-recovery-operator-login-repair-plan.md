...
> Source revision: `027af8b4271d60ffc193967d092b5d2497af13ad`. Original-artifact SHA-256 (NOT this redacted text): `d291e8fd7085ff9b07c695277630ace5dd4bbbe6a9917aa38058332b08a0d3d5`.
...
The user ratified exactly `signin:AuthorizeOAuth2Access` and `signin:CreateOAuth2Token`, scoped to `arn:aws:signin:us-west-1:<REDACTED_ACCOUNT_ID>:oauth2/public-client/remote`, after live `aws login --remote` failed because the operator lacked AWS's required OAuth permissions.
