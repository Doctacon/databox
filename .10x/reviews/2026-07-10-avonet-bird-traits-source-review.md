...
- The order-dependent legacy source VCR isolation defect predates this change and is durably owned by `.10x/tickets/done/2026-07-10-repair-source-vcr-and-schema-snapshot-suite.md`.
