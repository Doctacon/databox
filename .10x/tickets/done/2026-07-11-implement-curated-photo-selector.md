...
- 2026-07-12: User ratified v2 exact taxon resolution followed by v1 `/v1/taxa/{id}` curated-shortlist metadata. Active authority: `https://github.com/Doctacon/rufous/blob/main/.10x/decisions/inaturalist-curated-photo-api-split.md` and updated governing spec. Execution resumed.
