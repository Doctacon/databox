...
- Every scenario in `https://github.com/Doctacon/rufous/blob/main/.10x/specs/curated-inaturalist-representative-bird-photos.md` maps to recorded evidence.
...
- 2026-07-13: The user superseded Wikimedia-first behavior after two safe WDQS failures and observed `invalid unavailable photo` in the built app. Aggregate verification now targets `https://github.com/Doctacon/rufous/blob/main/.10x/specs/curated-inaturalist-representative-bird-photos.md`; historical Wikimedia aggregate evidence remains informative but cannot close the active contract.
