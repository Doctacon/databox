...
Repair and review pgBackRest connectivity for the intentionally `polaris`-owned PostgreSQL cluster, then rerun the authorized proof. Polaris must remain unavailable until stanza, WAL, and required backup validation pass.
