...
Independently review and explicitly approve plan hash `276b5ad36a1a6a13577a2b4b9a3e985c0e0ff1d0fe41340ec61221860f945f45`; do not init, refresh, or regenerate first. Then prove operator `aws login`, MFA-protected role assumption, and root logout before injecting role credentials into Compose. Preserve `infra/recovery/terraform.tfstate` and include it in the operator's encrypted machine backup.
