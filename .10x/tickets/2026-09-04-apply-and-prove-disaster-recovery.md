...
Independently review and explicitly approve the new local binary hash `45a78d799032c227b1d525433515e2093b452be0f346ea4c2a6d14d9ae5bbc35`. Do not run `tofu init`, refresh state, or alter configuration first. After a successful apply, manually enable console access and MFA before role-assumption proof. Preserve `infra/recovery/terraform.tfstate` and include it in the operator's encrypted machine backup.
