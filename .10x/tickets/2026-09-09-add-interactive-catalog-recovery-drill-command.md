...
Implement the concrete Docker/PostgreSQL/Polaris/WAL/validator operations adapter, backward-compatible `drill` CLI dispatch, thin Task target, documentation, concrete-adapter hermetic tests, and independent review before live use.
