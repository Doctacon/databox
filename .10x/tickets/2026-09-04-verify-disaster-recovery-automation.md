...
`.10x/tickets/2026-09-04-build-isolated-catalog-recovery-drill.md` remains open only on REST-response-versus-S3-metadata snapshot-divergence validation. The timed-drill dependency is not cleared.
