...
Implement and separately authorize registry-derived all-table metadata/snapshot/read validation. Do not delete or reuse recovery artifacts without authorization. Complete failure-path coverage and the timed drill remain unimplemented.
