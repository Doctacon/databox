...
Separately authorize restored Polaris startup and registry-derived validation. Do not delete or reuse recovery artifacts without authorization. Complete failure-path coverage and the timed drill remain unimplemented.
