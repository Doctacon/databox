...
- active architecture/specification records under `.10x/`, especially `.10x/specs/superseded/parallel-quack-local-refresh.md` and `.10x/specs/superseded/local-only-databox-platform.md`;
