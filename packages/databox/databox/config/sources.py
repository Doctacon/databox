...
class Source:
    ...
    @property
    def resource_tables(self) -> tuple[str, ...]:
        """Top-level tables backed by independent dlt resources."""
        return tuple(table for table in self.raw_tables if "__" not in table)
