...
class Source:
    ...
    Fields:
      ...
      normalized_child_tables: explicit subset of raw_tables generated by dlt
        normalization rather than backed by independent resources. Order-stable.
    ...
    def resource_tables(self) -> tuple[str, ...]:
        ...
        normalized_children = set(self.normalized_child_tables)
        return tuple(table for table in self.raw_tables if table not in normalized_children)
