...
Usage:
    python scripts/platform/bootstrap.py                              # no-op dry-run
    python scripts/platform/bootstrap.py --name Weatherbox ...        # apply
    python scripts/platform/bootstrap.py --check                      # non-zero on drift
"""
