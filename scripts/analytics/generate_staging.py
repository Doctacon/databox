...
Usage:
    python scripts/analytics/generate_staging.py              # regenerate staging SQL in place
    python scripts/analytics/generate_staging.py --check      # exit 1 if committed SQL drifts
    ...
    try:
        if a.check:
            ...
            if drifted:
                ...
                print(
                    "\nRun `python scripts/analytics/generate_staging.py` to regenerate, "
