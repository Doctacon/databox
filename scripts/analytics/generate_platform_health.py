...
Usage:
    python scripts/analytics/generate_platform_health.py              # regenerate in place
    python scripts/analytics/generate_platform_health.py --check      # exit 1 if committed drifts
    ...
    try:
        if a.check:
            if check_drift():
                ...
                print(
                    "Run `python scripts/analytics/generate_platform_health.py` to regenerate.",
                    file=sys.stderr,
                )
                return 1
