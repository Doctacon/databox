...
Usage:
    python scripts/sources/new_source.py <name>
    python scripts/sources/new_source.py <name> --shape file
    python scripts/sources/new_source.py <name> --dry-run
"""
...
def print_next_steps(name: str, verification_profile: str) -> None:
    ...
    print(
        ...
        "`python scripts/sources/check_source_layout.py` and the CI matrix fail. "
